...
?>
            ...
            <li class="col-sm-3 col-xs-3">
            	<a href="<?php echo $this->_var['nav']['url']; ?>">
                    <i class="search_on"><img src="<?php echo $this->_var['nav']['pic']; ?>" width="50" height="50"></i>
                    <p class="text-center search_on"><?php echo $this->_var['nav']['name']; ?></p>
                </a>
            </li>
            <?php endif; ?>
    ...
    <div class="gridRow" style='display:none;'><?php 
$k =array (
  'name' => 'ads',
  'id' => '2',
  'num' => '4',
...
?></div>
    ...
    <div class="indexlist" style='display:none;'>
...
?>
    ...
    <div style="padding-bottom:4.2em;display:;"></div>
</div>
