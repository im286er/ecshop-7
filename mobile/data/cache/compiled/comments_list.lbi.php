...
<li>
  ...
  <p><?php echo $this->_var['lang']['reply_comment']; ?>：<?php echo $this->_var['val']['reply_content']; ?></p>
  <?php endif; ?>
  <?php if ($this->_var['comment']['re_content']): ?>
  <p><span class="pull-left" style="width:100%; text-indent:0; position:relative;"><span style="position:absolute; top:0; left:0;">回复：</span><span style="padding-left:3em; display:block;"><?php echo $this->_var['comment']['re_content']; ?></span></span></p>
  <?php endif; ?>
  ...
  <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
    <div class="ect-padding-lr">
      ...
      <p class="ect-padding-tb code"><span>
        ...
        </span> <img class="pull-right" src="<?php echo url('public/captcha', array('rand'=>$this->_var['rand']));?>" alt="captcha" onClick="this.src='<?php echo url('public/captcha');?>&rand='+Math.random()"  />
        </p>
		<?php endif; ?>
      <p class="ect-padding-tb">
