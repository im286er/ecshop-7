...
//seckill 添加左侧菜单 ecmoban模板堂 shao
//名字一定要和inc_menu.php（ /admin/includes/inc_menu.php 添加菜单项）读取的名字一样！
$_LANG['16_seckill_action'] = '商品抢购';
$_LANG['seckill_add'] = '添加抢购活动';
/* 订单管理 */
...
//
/* 秒杀管理 */
$_LANG['16_secKill'] = '秒杀活动';
$_LANG['secKill_goods_list'] = '秒杀活动商品列表';
$_LANG['secKill_goods_add'] = '添加秒杀活动新商品';
