...
function create_html_kindeditor2($input_name, $input_value = '')
{
    global $smarty;
    $kindeditor="<script charset='utf-8' src='../includes/kindeditor/kindeditor-min.js'></script>
    <script>
        var editor2;
            KindEditor.ready(function(K) {
                editor2 = K.create('textarea[name=\"$input_name\"]', {
                    allowFileManager : true,
                    width : '780px',
                    height: '500px',
                    resizeType: 0    //固定宽高
...
function create_html_kindeditor3($input_name, $input_value = '')
{
    global $smarty;
    $kindeditor="<script charset='utf-8' src='../includes/kindeditor/kindeditor-min.js'></script>
    <script>
        var editor3;
            KindEditor.ready(function(K) {
                editor3 = K.create('textarea[name=\"$input_name\"]', {
                    allowFileManager : true,
                    width : '780px',
                    height: '500px',
                    resizeType: 0    //固定宽高
    ...
    <textarea id=\"$input_name\" name=\"$input_name\" style='width:600px;height:500px;'>$input_value</textarea>
    ";
    $smarty->assign('FCKeditor3', $kindeditor);  //这里前面的 FCKEditor 不要变 
}
