...
<a href="<?php echo $this->_var['hot_goods']['url']; ?>"><img src="<?php echo $this->_var['hot_goods']['goods_img']; ?>" alt="<?php echo $this->_var['hot_goods']['name']; ?>"></a>
  <dl>
    ...
    <dd class="dd-price"><span class="pull-left"><strong>价格：<b class="ect-colory"><?php if ($this->_var['hot_goods']['promote_price']): ?><?php echo $this->_var['hot_goods']['promote_price']; ?><?php else: ?><?php echo $this->_var['hot_goods']['shop_price']; ?><?php endif; ?></b></strong> <small class="ect-margin-lr"><del><?php echo $this->_var['hot_goods']['market_price']; ?></del></small></span> <span class="ect-pro-price"> 
...
?> 
    ...
    <dd class="dd-num">
      <span class="pull-right"><?php echo $this->_var['lang']['sort_sales']; ?><?php echo $this->_var['hot_goods']['sales_count']; ?><?php echo $this->_var['lang']['piece']; ?></span>
      <span class="pull-right<?php if ($this->_var['hot_goods']['mysc'] != 0): ?> ect-colory<?php endif; ?>"><i class="fa<?php if ($this->_var['hot_goods']['mysc'] != 0): ?> fa-heart<?php else: ?> fa-heart-o<?php endif; ?>"></i> <?php echo $this->_var['hot_goods']['sc']; ?><?php echo $this->_var['lang']['like_num']; ?></span> 
    </dd>
  </dl>
<?php endif; ?> 
