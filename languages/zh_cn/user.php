...
/* 会员密码找回 */
$_LANG['username_and_email'] = "请输入您的用户名及电子邮件地址";
...
$_LANG['agreement'] = "我已阅读并接受<a href=\\\\\\\"article.php?cat_id=-1\\\\\\\" target=\\\\\\\"_blank\\\\\\\" style=\\\\\\\"color:#f10180;\\\\\\\">唯品会服务条款</a>。";
...
$_LANG['your_surplus'] = "余　　额";
$_LANG['credit_line'] = '信用额度';
$_LANG['your_bonus'] = "红　　包";
$_LANG['your_message'] = '留言';
$_LANG['your_order'] = '订单';
$_LANG['your_integral'] = "积　　分";
