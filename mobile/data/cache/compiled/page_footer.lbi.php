...
<a class="scrollUp" href="<?php echo url('flow/cart');?>" style="position: fixed; z-index: 10; right:.25em;bottom:1.2em;left:auto;"><i class="fa fa-angle"></i><span class="flow_cart_num"></span></a>
