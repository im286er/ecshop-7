...
?>
                    <span>
                    	<a href="<?php echo $this->_var['child']['url']; ?>"><img class="pull-left" src="<?php echo $this->_var['child']['cat_image']; ?>"><p><?php echo htmlspecialchars($this->_var['child']['name']); ?></p></a></span>
