...
else
{
    ...
    /* 查询商品 */
    $sql = "SELECT g.goods_id, g.goods_name, b.brand_name,g.brand_id,g.market_price, g.is_new, g.comments_number, g.sales_volume, g.is_best, g.is_hot, g.shop_price AS org_price, ".
